...
struct Stats {
  ...
  int64_t decisionsSimRead = 0; // number of decisions in 'decide'
  int64_t analysis, negUipIsLastDecs;
  
  int64_t conflicts2 = 0; // generated conflicts in 'propagate'
  
  double_t sumPercDecs = 0;
  int64_t  sumNumLemmas = 0;
  int64_t  numFirstLitIsEmpow = 0, num2ndLitIsEmpow = 0;
