...
struct Internal {
  ...
  bool read_sequence;  // default 'false'
  //-----------------------------
  ...
  Clause *new_learned_redundant_clause (const vector<int>& lits, int glue);
  ...
  void clear_flags_and_count_opens (Clause* c);
  void analyze ();
