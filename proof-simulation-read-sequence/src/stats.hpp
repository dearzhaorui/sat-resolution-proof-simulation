...
struct Stats {
  ...
  int64_t  sumNumLemmas = 0, sumNumLemmasWithDecs = 0;
  int64_t  numEmpowerLongCls = 0, numEmpowerFirstLit = 0;
  int64_t  otfsBT = 0, otfsPos1 = 0, otfsPos2 = 0;
  int64_t  numAnalyze = 0;
